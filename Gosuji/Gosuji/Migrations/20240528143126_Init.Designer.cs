...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gosuji.Data.Discount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.FeedbackType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.Game", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.GameStat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.KataGoVersion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.Language", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.SettingConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.SubscriptionType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.TrainerSettingConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.UserSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Gosuji.Data.Feedback", b =>
                {
                    b.HasOne("Gosuji.Data.FeedbackType", "FeedbackType")
                        .WithMany()
            ...
            modelBuilder.Entity("Gosuji.Data.Game", b =>
                {
                    b.HasOne("Gosuji.Data.GameStat", "EndgameStat")
                        .WithMany()
                        .HasForeignKey("EndgameStatId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Gosuji.Data.GameStat", "GameStat")
                        .WithMany()
                        .HasForeignKey("GameStatId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Gosuji.Data.KataGoVersion", "kataGoVersion")
                        .WithMany()
                        .HasForeignKey("KataGoVersionId");

                    b.HasOne("Gosuji.Data.GameStat", "MidgameStat")
                        .WithMany()
                        .HasForeignKey("MidgameStatId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Gosuji.Data.GameStat", "OpeningStat")
                        .WithMany()
                        .HasForeignKey("OpeningStatId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Gosuji.Data.TrainerSettingConfig", "TrainerSettingConfig")
                        .WithMany()
            ...
            modelBuilder.Entity("Gosuji.Data.SettingConfig", b =>
                {
                    b.HasOne("Gosuji.Data.Language", "Language")
                        .WithMany()
            ...
            modelBuilder.Entity("Gosuji.Data.User", b =>
                {
                    b.HasOne("Gosuji.Data.SettingConfig", "SettingConfig")
                        .WithMany()
            ...
            modelBuilder.Entity("Gosuji.Data.UserSubscription", b =>
                {
                    b.HasOne("Gosuji.Data.Discount", "Discount")
                        .WithMany()
                        .HasForeignKey("DiscountId");

                    b.HasOne("Gosuji.Data.SubscriptionType", "SubscriptionType")
                        .WithMany()
                    ...
                    b.HasOne("Gosuji.Data.User", "User")
                        ...
                        .HasForeignKey("Gosuji.Data.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
